...
\cvsec{OPEN-SOURCE}
\begin{itemize}
  \item Enhanced code quality of the \textit{\href{https://github.com/golang/go/commits/master/?author=alirezaarzehgar}{\color{gray} Go standard library}}
  for v1.24 with successful code reviews.
  \item Developed a \textit{\href{https://github.com/alirezaarzehgar/writy}{\color{gray} distributed NoSQL DB}}
  and its \textit{\href{https://github.com/alirezaarzehgar/writy-operator}{\color{gray} Kubernetes Operator}} using Go and \textbf{Operator-SDK}.
