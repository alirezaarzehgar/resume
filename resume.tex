...
\begin{itemize}
  ...
  \item Architected event-driven architecture solutions for 3 applications using \textbf{Kafka} and \textbf{RabbitMQ}.
\end{itemize}
...
\begin{itemize}
  \item Designed a networking performance lab using \textbf{Python} and TRex to measure over 10 routers.
