...
Enthusiastic Software Engineer with over 4 years of professional experience and 6 years of advocacy in Unix systems.
Passionate about Software SRE, with contributions to open-source projects and a proven ability to design software solutions.
Familiar with developing Kubernetes applications using Operator-SDK and automating tasks with Golang, Bash, and Python.
...
\begin{minipage}{\textwidth}
  \begin{multicols}{2}
    ...
    \begin{minipage}{0.5\textwidth}
      \cvsec{SKILLS}
      Go, Kubernetes, Operator-SDK, gRPC, Unix, Python, Bash,
      SQL, Docker, Git, Nginx, \LaTeX, Postman, PAM, C
    \end{minipage}
  \end{multicols}
\end{minipage}
