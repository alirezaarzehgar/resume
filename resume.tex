...
\begin{itemize}
  ...
  \item Developed a \textit{\href{https://github.com/alirezaarzehgar/writy}{\color{darkgray} distributed NoSQL DB}}
  and its \textit{\href{https://github.com/alirezaarzehgar/writy-operator}{\color{darkgray} Kubernetes Operator}} using Go and \textbf{Operator-SDK}.
...
\begin{minipage}{\textwidth}
  \begin{multicols}{2}
    ...
    \begin{minipage}{0.5\textwidth}
      \cvsec{SKILLS}
      Go, Kubernetes, Operator-SDK, Unix, Python, Bash,
