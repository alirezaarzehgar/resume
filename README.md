...
Four years ago, I started my first job as an Embedded Network Engineer at ZharfPooyan Toos when I was 17.
At ZharfPooyan, I worked on routers and switches using C and Unix-related technologies.
There, I automated performance testing of network appliances and designed a robust network lab.

After my experience at ZharfPooyan, I became passionate about the Go programming language and began a new journey
with Golang, Docker, and backend development. Whenever I designed a backend solution, I prioritized simplicity,
correctness, cloud-friendliness, and scalability.

I started working at Arttizens crypto exchange as a Golang Developer.
There, I learned cloud-related concepts and gained experience developing backend solutions.
I have experience developing Go software and working with queue systems such as NATS, RabbitMQ, and Kafka.

At that time, strengthening my academic foundations and core fundamentals in my field was my top priority,
so I decided to dedicate two semesters to focused study in order to achieve excellent grades.

After one year, I began a new position at Part Financial Data Processing Company as a Software Engineer.
My main challenges involved concurrency, crafting Go software, and optimizing PostgreSQL queries and databases.
In this role, I was also responsible for all DevOps-related tasks, building the entire DevOps stack using Kubernetes.
I handled operational challenges, particularly identifying and resolving system bottlenecks and addressing operational issues.

If my story has caught your interest, I invite you to hear more in an interview!
